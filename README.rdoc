WORKING ON: As a user, I can only vote for links that I haven't voted for and does not belong to me. (WRITING SPEC)--positive specs
...
* new page should rank it by newest_create_by
